...
public class EBusTelegramParser {
	...
	private Object getValue(ByteBuffer byteBuffer, TelegramValue telegramValue) {
		...
		BigDecimal valueMin = NumberUtils.toBigDecimal(telegramValue.getMin());
		BigDecimal valueMax = NumberUtils.toBigDecimal(telegramValue.getMax());
		BigDecimal replaceValue = NumberUtils.toBigDecimal(telegramValue.getReplaceValue());
		BigDecimal factor = NumberUtils.toBigDecimal(telegramValue.getFactor());
