...
dhw.temp_cylinder.status        | dhw.temp_cylinder           | Number    | Storage temperature status - {0=ok, 85=circuit, 170=cutoff}
...
heating.pressure.status         | heating.pressure            | Number    | Status system pressure - {0=ok, 85=circuit, 170=cutoff}    
